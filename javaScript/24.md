...
정의가 무척이나 난해해서 무슨 의미인지 잘 와 닿지 않는다.
...
[“13.5. 렉시컬 스코프”](https://poiemaweb.com/fastcampus/scope#5-렉시컬-스코프)에서 살펴보았던 예제를 다시 한번 살펴보자.
...
[“24.1 렉시컬 스코프”](https://poiemaweb.com/fastcampus/closure#1-렉시컬-스코프)에서 살펴보았듯이 위 정의에서 “그 함수가 선언된 렉시컬 환경”이란 함수가 정의된 위치의 스코프, 즉 상위 스코프를 의미하는 실행 컨텍스트의 렉시컬 환경을 말한다.
...
![img](https://poiemaweb.com/assets/fs-images/24-6.png)
...
![img](https://poiemaweb.com/assets/fs-images/24-7.png)
...
![img](https://poiemaweb.com/assets/fs-images/24-8.png)
...
하지만 카운트 상태는 전역 변수를 통해 관리되고 있기 때문에 언제든지 누구나 접근할 수 있고 변경할 수 있다.(암묵적 결합, [“14.2. 전역 변수의 문제점”](https://poiemaweb.com/fastcampus/global-variable#2-전역-변수의-문제점) 참고) 이는 의도치 않게 상태가 변경될 수 있다는 것을 의미한다. 만약 누군가에 의해 의도치 않게 카운트 상태, 즉 전역 변수 num의 값이 변경되면 이는 오류로 이어진다.
...
Array 생성자 함수와 Array.from, Array.prototype.fill, Array.prototype.forEach 메서드에 대해서는 [“27. 배열”](https://poiemaweb.com/fastcampus/array)에서 자세히 살펴보도록 하자. 아직 살펴보지 않은 화살표 함수에 대해서는 [“26.3 화살표 함수”](https://poiemaweb.com/fastcampus/es6-function#3-화살표-함수)에서 자세히 살펴보자.