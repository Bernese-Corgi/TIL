...
[JAVASCRIPT](https://poiemaweb.com/fastcampus)[Go to table of contents](javascript:void(0))

[“38.3. HTML 파싱과 DOM 생성”](https://poiemaweb.com/fastcampus/browser-rendering#3-html-파싱과-dom-생성)에서 살펴본 바와 같이 브라우저의 렌더링 엔진은 HTML 문서를 파싱하여 브라우저가 이해할 수 있는 자료구조인 DOM을 생성한다. **DOM(Document Object Model)은 HTML 문서의 계층적 구조와 정보를 표현하며 이를 제어할 수 있는 API, 즉 프로퍼티와 메서드를 제공하는 트리 자료구조이다.** DOM에 대해 자세히 살펴보자.

# [#](https://poiemaweb.com/fastcampus/dom#1-노드)1. 노드

## [#](https://poiemaweb.com/fastcampus/dom#11-html-요소와-노드-객체)1.1. HTML 요소와 노드 객체

HTML 요소(HTML element)는 HTML 문서를 구성하는 개별적인 요소를 의미한다.

![img](https://poiemaweb.com/assets/fs-images/39-1.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#12-노드-객체의-타입)1.2. 노드 객체의 타입
...
- 공백 텍스트 노드
  ...
  정확히 말하자면 위 그림에는 공백 텍스트 노드가 생략되어 있다. HTML 요소 사이의 개행이나 공백은 텍스트 노드가 된다. 이에 대해서는 [“39.3.1 공백 텍스트 노드”](https://poiemaweb.com/fastcampus/dom#31-공백-텍스트-노드)에서 자세히 살펴보자.
...
- - **어트리뷰트 노드**
    ...
    어트리뷰트 노드(attribute node)는 HTML 요소의 어트리뷰트를 가리키는 객체다. 어트리뷰트 노드는 어트리뷰트가 지정된 HTML 요소의 요소 노드와 연결되어 있다. 단, 요소 노드는 부모 노드와 연결되어 있지만 어트리뷰트 노드는 부모 노드와 연결되어 있지 않고 요소 노드에만 연결되어 있다. 즉, 어트리뷰트 노드는 부모 노드가 없으므로 요소 노드의 형제(sibling) 노드는 아니다. 따라서 어트리뷰트 노드에 접근하여 어트리뷰트를 참조하거나 변경하려면 먼저 요소 노드에 접근해야 한다.
...
위 4가지 노드 타입 이외에도 주석을 위한 Comment 노드, DOCTYPE을 위한 DocumentType 노드, 복수의 노드를 생성하여 추가할 때 사용하는 DocumentFragment 노드 등 총 12개의 노드 타입이 있다. DocumentFragment 노드에 대해서는 [“39.6.4. 복수의 노드 생성과 추가”](https://poiemaweb.com/fastcampus/dom#64-복수의-노드-생성과-추가)에서 자세히 살펴보자.

## [#](https://poiemaweb.com/fastcampus/dom#13-노드-객체의-상속-구조)1.3. 노드 객체의 상속 구조

이번 절은 무척 어렵게 느껴질 수도 있다. 노드 객체의 상속 구조를 자세히 알아야 할 필요는 없으니 가벼운 마음으로 읽어 주기 바란다. 대략적인 개요만 이해해도 충분하다.
...
![img](https://poiemaweb.com/assets/fs-images/39-6.png)
...
![img](https://poiemaweb.com/assets/fs-images/39-7.png)
...
# [#](https://poiemaweb.com/fastcampus/dom#2-요소-노드-취득)2. 요소 노드 취득
...
## [#](https://poiemaweb.com/fastcampus/dom#21-id를-이용한-요소-노드-취득)2.1. id를 이용한 요소 노드 취득
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 88px;"></iframe>
...
## [#](https://poiemaweb.com/fastcampus/dom#22-태그-이름을-이용한-요소-노드-취득)2.2. 태그 이름을 이용한 요소 노드 취득
...
함수는 하나의 값만 반환할 수 있으므로 여러 개의 값을 반환하려면 배열이나 객체와 같은 자료구조에 담아 반환해야 한다. getElementsByTagName 메서드가 반환하는 DOM 컬렉션 객체인 HTMLCollection 객체는 [유사 배열 객체이면서 이터러블](https://poiemaweb.com/fastcampus/iterable#4-이터러블과-유사-배열-객체)이다.

![img](https://poiemaweb.com/assets/fs-images/39-8.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#23-class를-이용한-요소-노드-취득)2.3. class를 이용한 요소 노드 취득
...
## [#](https://poiemaweb.com/fastcampus/dom#24-css-선택자를-이용한-요소-노드-취득)2.4. CSS 선택자를 이용한 요소 노드 취득
...
## [#](https://poiemaweb.com/fastcampus/dom#25-특정-요소-노드를-취득할-수-있는지-확인)2.5. 특정 요소 노드를 취득할 수 있는지 확인
...
Element.prototype.matches 메서드는 이벤트 위임을 사용할 때 유용하다. 이에 대해서는 [“35.7. 이벤트 위임”](https://poiemaweb.com/fastcampus/event#7-이벤트-위임)에서 자세히 살펴보자.

## [#](https://poiemaweb.com/fastcampus/dom#26-htmlcollection과-nodelist)2.6. HTMLCollection과 NodeList

DOM 컬렉션 객체인 HTMLCollection과 NodeList는 DOM API가 여러 개의 결과값을 반환하기 위한 DOM 컬렉션 객체다. HTMLCollection과 NodeList는 모두 유사 배열 객체이면서 이터러블이다. 따라서 for…of 문으로 순회할 수 있으며 [스프레드 문법](https://poiemaweb.com/fastcampus/spread-syntax)을 사용하여 간단히 배열로 변환할 수 있다.
...
### [#](https://poiemaweb.com/fastcampus/dom#261-htmlcollection)2.6.1. HTMLCollection
...
위 예제는 getElementsByClassName 메서드로 class 값이 ‘red’인 요소 노드를 모두 취득하고, 취득된 모든 요소 노드를 담고 있는 HTMLCollection 객체를 for 문으로 순회하며 [className 프로퍼티](https://poiemaweb.com/fastcampus/dom#821-classname)를 사용하여 모든 요소의 class 값을 ‘red’에서 ‘blue’로 변경한다.
...
### [#](https://poiemaweb.com/fastcampus/dom#262-nodelist)2.6.2 NodeList
...
NodeList 객체는 대부분의 경우 노드 객체의 상태 변경을 실시간으로 반영하지 않고 과거의 정적 상태를 유지하는 non-live 객체로 동작한다. 하지만 **[childNodes 프로퍼티](https://poiemaweb.com/fastcampus/dom#32-자식-노드-탐색)가 반환하는 NodeList 객체는 HTMLCollection 객체와 같이 실시간으로 노드 객체의 상태 변경을 반영하는 live 객체로 동작하므로 주의가 필요하다.**
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 68px;"></iframe>
...
HTMLCollection과 NodeList 객체는 모두 유사 배열 객체이면서 이터러블이다. 따라서 [스프레드 문법](https://poiemaweb.com/fastcampus/spread-syntax#24-이터러블을-배열로-변환)이나 [Array.from 메서드](https://poiemaweb.com/fastcampus/array#44-arrayfrom)를 사용하여 간단히 배열로 변환할 수 있다.
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 30px;"></iframe>

# [#](https://poiemaweb.com/fastcampus/dom#3-노드-탐색)3. 노드 탐색
...
![img](https://poiemaweb.com/assets/fs-images/39-10.png)
...
노드 탐색 프로퍼티는 모두 [접근자 프로퍼티](https://poiemaweb.com/fastcampus/property-definition#32-접근자-프로퍼티)다. 단, 노드 탐색 프로퍼티는 setter없이 getter만 존재하여 참조만 가능한 읽기 전용 접근자 프로퍼티다. 읽기 전용 접근자 프로퍼티에 값을 할당하면 아무런 에러 없이 무시된다.

![img](https://poiemaweb.com/assets/fs-images/39-11.png)

읽기 전용 접근자 프로퍼티

## [#](https://poiemaweb.com/fastcampus/dom#31-공백-텍스트-노드)3.1. 공백 텍스트 노드
...
![img](https://poiemaweb.com/assets/fs-images/39-12.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#32-자식-노드-탐색)3.2. 자식 노드 탐색
...
## [#](https://poiemaweb.com/fastcampus/dom#33-자식-노드-존재-확인)3.3. 자식 노드 존재 확인
...
## [#](https://poiemaweb.com/fastcampus/dom#34-요소-노드의-텍스트-노드-탐색)3.4. 요소 노드의 텍스트 노드 탐색
...
## [#](https://poiemaweb.com/fastcampus/dom#35-부모-노드-탐색)3.5. 부모 노드 탐색
...
## [#](https://poiemaweb.com/fastcampus/dom#36-형제-노드-탐색)3.6. 형제 노드 탐색
...
# [#](https://poiemaweb.com/fastcampus/dom#4-노드-정보-취득)4. 노드 정보 취득
...
# [#](https://poiemaweb.com/fastcampus/dom#5-요소-노드의-텍스트-조작)5. 요소 노드의 텍스트 조작

## [#](https://poiemaweb.com/fastcampus/dom#51-nodevalue)5.1. nodeValue
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 49px;"></iframe>

## [#](https://poiemaweb.com/fastcampus/dom#52-textcontent)5.2. textContent
...
![img](https://poiemaweb.com/assets/fs-images/39-13.png)
...
![img](https://poiemaweb.com/assets/fs-images/39-14.png)
...
![img](https://poiemaweb.com/assets/fs-images/39-15.png)
...
# [#](https://poiemaweb.com/fastcampus/dom#6-dom-조작)6. DOM 조작

DOM 조작(DOM manipulation)은 새로운 노드를 생성하여 DOM에 추가하거나 기존 노드를 삭제 또는 교체하는 것을 말한다. DOM 조작에 의해 DOM에 새로운 노드가 추가되거나 삭제되면 [리플로우와 리페인트](https://poiemaweb.com/fastcampus/browser-rendering#7-리플로우와-리페인트)가 발생하는 원인이 되므로 성능에 영향을 준다. 따라서 복잡한 콘텐츠를 다루는 DOM 조작은 성능 최적화를 위해 주의해서 다루어야 한다.

## [#](https://poiemaweb.com/fastcampus/dom#61-innerhtml)6.1. innerHTML
...
![img](https://poiemaweb.com/assets/fs-images/39-16.png)
...
![img](https://poiemaweb.com/assets/fs-images/39-17.png)
...
- HTML 새니티제이션
  ...
  HTML 새니티제이션(HTML sanitization)은 사용자로부터 입력 받은 데이터(untrusted input data)에 의해 발생할 수 있는 크로스 사이트 스크립팅 공격을 예방하기 위해 잠재적 위험을 제거하는 기능을 말한다. 새니티제이션 함수를 직접 구현할 수도 있겠지만 [DOMPurify](https://github.com/cure53/DOMPurify) 라이브러리를 사용하는 것을 권장한다. DOMPurify는 다음과 같이 잠재적 위험을 내포한 HTML 마크업을 새니티제이션(살균)하여 잠재적 위험을 제거한다. `DOMPurify.sanitize('<img src="x" onerror="alert(document.cookie)">'); // => <img src="x">` DOMPurify는 2014년 2월부터 제공되기 시작했으므로 어느 정도 안정성이 보장된 새니티제이션 라이브러리라고 할 수 있다.
...
## [#](https://poiemaweb.com/fastcampus/dom#62-insertadjacenthtml-메서드)6.2. insertAdjacentHTML 메서드
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 190px;"></iframe>
...
## [#](https://poiemaweb.com/fastcampus/dom#63-노드-생성과-추가)6.3. 노드 생성과 추가
...
### [#](https://poiemaweb.com/fastcampus/dom#631-요소-노드-생성)6.3.1. 요소 노드 생성
...
### [#](https://poiemaweb.com/fastcampus/dom#632-텍스트-노드-생성)6.3.2. 텍스트 노드 생성
...
### [#](https://poiemaweb.com/fastcampus/dom#633-텍스트-노드를-요소-노드의-자식-노드로-추가)6.3.3. 텍스트 노드를 요소 노드의 자식 노드로 추가
...
### [#](https://poiemaweb.com/fastcampus/dom#634-요소-노드를-dom에-추가)6.3.4. 요소 노드를 DOM에 추가
...
이 과정에서 비로소 새롭게 생성한 요소 노드가 DOM에 추가된다. 기존의 DOM에 요소 노드를 추가하는 처리는 이 과정 뿐이다. 위 예제는 단 하나의 요소 노드를 생성하여 DOM에 한번 추가하므로 DOM은 한 번 변경된다. 이때 [리플로우와 리페인트](https://poiemaweb.com/fastcampus/browser-rendering#7-리플로우와-리페인트)가 실행된다.

## [#](https://poiemaweb.com/fastcampus/dom#64-복수의-노드-생성과-추가)6.4. 복수의 노드 생성과 추가
...
![img](https://poiemaweb.com/assets/fs-images/39-23.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#65-노드-삽입)6.5. 노드 삽입

### [#](https://poiemaweb.com/fastcampus/dom#651-마지막-노드로-추가)6.5.1. 마지막 노드로 추가
...
![img](https://poiemaweb.com/assets/fs-images/39-24.png)

appendChild 메서드

### [#](https://poiemaweb.com/fastcampus/dom#652-지정한-위치에-노드-삽입)6.5.2. 지정한 위치에 노드 삽입
...
![img](https://poiemaweb.com/assets/fs-images/39-25.png)
...
![img](https://poiemaweb.com/assets/fs-images/39-26.png)

insertBefore 메서드의 두 번째 인수로 전달받은 노드가 null인 경우

## [#](https://poiemaweb.com/fastcampus/dom#66-노드-이동)6.6. 노드 이동
...
![img](https://poiemaweb.com/assets/fs-images/39-27.png)

노드 이동

## [#](https://poiemaweb.com/fastcampus/dom#67-노드-복사)6.7. 노드 복사
...
![img](https://poiemaweb.com/assets/fs-images/39-28.png)

노드 복사

## [#](https://poiemaweb.com/fastcampus/dom#68-노드-교체)6.8. 노드 교체
...
![img](https://poiemaweb.com/assets/fs-images/39-29.png)

노드 교체

## [#](https://poiemaweb.com/fastcampus/dom#69-노드-삭제)6.9. 노드 삭제
...
![img](https://poiemaweb.com/assets/fs-images/39-30.png)

노드 삭제

# [#](https://poiemaweb.com/fastcampus/dom#7-어트리뷰트)7. 어트리뷰트

## [#](https://poiemaweb.com/fastcampus/dom#71-어트리뷰트-노드와-attributes-프로퍼티)7.1. 어트리뷰트 노드와 attributes 프로퍼티
...
![img](https://poiemaweb.com/assets/fs-images/39-31.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#72-html-어트리뷰트-조작)7.2. HTML 어트리뷰트 조작
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 52px;"></iframe>
...
## [#](https://poiemaweb.com/fastcampus/dom#73-html-어트리뷰트-vs-dom-프로퍼티)7.3. HTML 어트리뷰트 vs. DOM 프로퍼티
...
![img](https://poiemaweb.com/assets/fs-images/39-32.png)
...
### [#](https://poiemaweb.com/fastcampus/dom#731-어트리뷰트-노드)7.3.1. 어트리뷰트 노드
...
![img](https://poiemaweb.com/assets/fs-images/39-33.png)

setAttribute 메서드

### [#](https://poiemaweb.com/fastcampus/dom#732-dom-프로퍼티)7.3.2. DOM 프로퍼티
...
### [#](https://poiemaweb.com/fastcampus/dom#733-html-어트리뷰트와-dom-프로퍼티의-대응-관계)7.3.3. HTML 어트리뷰트와 DOM 프로퍼티의 대응 관계
...
- class 어트리뷰트는 className, classList 프로퍼티와 대응한다([“39.8.2. 클래스 조작”](https://poiemaweb.com/fastcampus/dom#82-클래스-조작) 참고).
- for 어트리뷰트는 htmlFor 프로퍼티와 1:1 대응한다.
- td 요소의 colspan 어트리뷰트는 대응하는 프로퍼티가 존재하지 않는다.
- textContent 프로퍼티는 대응하는 어트리뷰트가 존재하지 않는다.
- 어트리뷰트 이름은 대소문자를 구별하지 않지만 대응하는 프로퍼티 키는 카멜 케이스를 따른다(maxlength → maxLength).

### [#](https://poiemaweb.com/fastcampus/dom#734-dom-프로퍼티-값의-타입)7.3.4. DOM 프로퍼티 값의 타입
...
## [#](https://poiemaweb.com/fastcampus/dom#74-data-어트리뷰트와-dataset-프로퍼티)7.4. data 어트리뷰트와 dataset 프로퍼티
...
# [#](https://poiemaweb.com/fastcampus/dom#8-스타일)8. 스타일

## [#](https://poiemaweb.com/fastcampus/dom#81-인라인-스타일-조작)8.1. 인라인 스타일 조작
...
![img](https://poiemaweb.com/assets/fs-images/39-34.png)
...
## [#](https://poiemaweb.com/fastcampus/dom#82-클래스-조작)8.2. 클래스 조작

`.`으로 시작하는 클래스 선택자를 사용하여 CSS class를 미리 정의한 다음, HTML 요소의 class 어트리뷰트 값을 변경하여 HTML 요소의 스타일을 변경할 수도 있다. 이때 HTML 요소의 class 어트리뷰트를 조작하려면 [“39.7. 어트리뷰트”](https://poiemaweb.com/fastcampus/dom#7-어트리뷰트)에서 살펴보았듯이 class 어트리뷰트에 대응하는 요소 노드의 DOM 프로퍼티를 사용한다.

단, 단, class 어트리뷰트에 대응하는 DOM 프로퍼티는 class가 아니라 className과 classList다. 자바스크립트에서 class는 예약어이기 때문이다.

### [#](https://poiemaweb.com/fastcampus/dom#821-classname)8.2.1. className
...
<iframe style="box-sizing: inherit; margin: 0px; padding: 0px; border: 0px; font-size: 16px; font-weight: 400; vertical-align: baseline; background: transparent; width: 484px; height: 130px;"></iframe>

className 프로퍼티는 문자열을 반환하므로 공백으로 구분된 여러 개의 클래스를 반환하는 경우 다루기가 불편하다.

### [#](https://poiemaweb.com/fastcampus/dom#822-classlist)8.2.2. classList
...
## [#](https://poiemaweb.com/fastcampus/dom#83-요소에-적용되어-있는-css-스타일-참조)8.3. 요소에 적용되어 있는 CSS 스타일 참조
...
# [#](https://poiemaweb.com/fastcampus/dom#9-dom-표준)9. DOM 표준
