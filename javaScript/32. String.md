...
# [#](https://poiemaweb.com/fastcampus/string#1-string-생성자-함수)1. String 생성자 함수

표준 빌트인 객체인 String 객체는 생성자 함수 객체다. 따라서 new 연산자와 함께 호출하여 String 인스턴스를 생성할 수 있다.

String 생성자 함수에 인수를 전달하지 않고 new 연산자와 함께 호출하면 [[StringData]] 내부 슬롯에 빈 문자열을 할당한 String [래퍼 객체](https://poiemaweb.com/fastcampus/built-in-object#3-원시-값과-래퍼-객체)를 생성한다.
...
[“11.1.2. 문자열과 불변성”](https://poiemaweb.com/fastcampus/primitive-vs-object#12-문자열과-불변성)에서 살펴보았듯이 String 래퍼 객체는 배열과 마찬가지로 length 프로퍼티와 인덱스를 나타내는 숫자 형식의 문자열을 프로퍼티 키로, 각 문자를 프로퍼티 값으로 갖는 유사 배열 객체이면서 이터러블이다. 따라서 배열과 유사하게 인덱스를 사용하여 각 문자에 접근할 수 있다.
...
# [#](https://poiemaweb.com/fastcampus/string#2-length-프로퍼티)2. length 프로퍼티
...
# [#](https://poiemaweb.com/fastcampus/string#3-string-메서드)3. String 메서드
...
## [#](https://poiemaweb.com/fastcampus/string#31-stringprototypeindexof)3.1. String.prototype.indexOf
...
## [#](https://poiemaweb.com/fastcampus/string#32-stringprototypesearch)3.2. String.prototype.search
...
## [#](https://poiemaweb.com/fastcampus/string#33-stringprototypeincludes)3.3. String.prototype.includes
...
## [#](https://poiemaweb.com/fastcampus/string#34-stringprototypestartswith)3.4. String.prototype.startsWith
...
## [#](https://poiemaweb.com/fastcampus/string#35-stringprototypeendswith)3.5. String.prototype.endsWith
...
## [#](https://poiemaweb.com/fastcampus/string#36-stringprototypecharat)3.6. String.prototype.charAt
...
## [#](https://poiemaweb.com/fastcampus/string#37-stringprototypesubstring)3.7. String.prototype.substring
...
## [#](https://poiemaweb.com/fastcampus/string#38-stringprototypeslice)3.8. String.prototype.slice
...
## [#](https://poiemaweb.com/fastcampus/string#39-stringprototypetouppercase)3.9. String.prototype.toUpperCase
...
## [#](https://poiemaweb.com/fastcampus/string#310-stringprototypetolowercase)3.10. String.prototype.toLowerCase
...
## [#](https://poiemaweb.com/fastcampus/string#311-stringprototypetrim)3.11. String.prototype.trim
...
[String.prototype.replace 메서드](https://poiemaweb.com/fastcampus/string#313-stringprototypereplace)에 [정규 표현식](https://poiemaweb.com/fastcampus/regexp)을 인수로 전달하여 공백 문자를 제거할 수도 있다.
...
## [#](https://poiemaweb.com/fastcampus/string#312-stringprototyperepeat)3.12. String.prototype.repeat
...
## [#](https://poiemaweb.com/fastcampus/string#313-stringprototypereplace)3.13. String.prototype.replace
...
## [#](https://poiemaweb.com/fastcampus/string#314-stringprototypesplit)3.14. String.prototype.split
